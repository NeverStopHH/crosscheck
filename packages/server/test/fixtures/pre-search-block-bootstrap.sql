-- The bootstrap DDL exactly as the PRE-SEARCH-BLOCK release ran it
-- (commit 5e556c1, packages/server/src/db/bootstrap.sql) — the upgrade test
-- uses it to build a data dir the way an existing install would have, then
-- boots the CURRENT createDb against it. Do not modernize this file: its
