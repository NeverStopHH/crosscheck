 ...
 *
 * VERIFY: bun -e 'const l=await import("./packages/connector-claude/src/http/latency.ts");console.log(l.recommendedTimeoutMs(500), l.recommendedTimeoutMs(0), l.recommendedTimeoutMs(10000))'
